...
# pyspark_viz_spaceflights documentation build
...
from pyspark_viz_spaceflights import __version__ as release

# -- Project information -----------------------------------------------------

project = "pyspark_viz_spaceflights"
author = "Kedro"
...
htmlhelp_basename = "pyspark_viz_spaceflightsdoc"
...
latex_documents = [
    (
        master_doc,
        "pyspark_viz_spaceflights.tex",
        "pyspark_viz_spaceflights Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "pyspark_viz_spaceflights",
        "Project pyspark_viz_spaceflights codebase.",
        "Data-Science",
    )
]
