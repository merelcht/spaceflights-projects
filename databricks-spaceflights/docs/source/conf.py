...
# databricks_spaceflights documentation build
...
from databricks_spaceflights import __version__ as release

# -- Project information -----------------------------------------------------

project = "databricks_spaceflights"
author = "Kedro"
...
htmlhelp_basename = "databricks_spaceflightsdoc"
...
latex_documents = [
    (
        master_doc,
        "databricks_spaceflights.tex",
        "databricks_spaceflights Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "databricks_spaceflights",
        "Project databricks_spaceflights codebase.",
        "Data-Science",
    )
]
