...
# pyspark_spaceflights documentation build
...
from pyspark_spaceflights import __version__ as release

# -- Project information -----------------------------------------------------

project = "pyspark_spaceflights"
author = "Kedro"
...
htmlhelp_basename = "pyspark_spaceflightsdoc"
...
latex_documents = [
    (
        master_doc,
        "pyspark_spaceflights.tex",
        "pyspark_spaceflights Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "pyspark_spaceflights",
        "Project pyspark_spaceflights codebase.",
        "Data-Science",
    )
]
